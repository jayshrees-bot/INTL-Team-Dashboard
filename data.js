...
const AGENTS = {
  ...
  "devadharshini": {
    ...
    "ncf": 2,
    "totalErrors": 9,
    "note": "Devadharshini D scored 75% this month across 10 audits, with 2 non conformance(s) flagged.",
    "params": {
      "ss": 3,
      "cc": 1,
      "prob": 0,
  ...
  "hiten": {
    ...
    "aois": [
      ...
      },
      {
        "cat": "fu",
        "label": "Follow Up",
        "text": "4 instance(s) flagged this month under Follow Up. Auditor notes: follow not seen | could have called the cx"
      },
      {
        "cat": "cc",
        "label": "Call/Chat Etiquette",
